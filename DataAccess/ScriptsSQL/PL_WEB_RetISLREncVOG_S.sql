...
IF EXISTS(SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[PL_WEB_RetISLREncVOG_S]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].PL_WEB_RetISLREncVOG_S
go
CREATE PROCEDURE PL_WEB_RetISLREncVOG_S
(@INTERID		VARCHAR(5)
,@RIF			VARCHAR(15)
...
,PRV_ESTADO				VARCHAR(31)
  ...
  --TRABAJO--
	SET @SQLSTR=CONCAT(' INSERT INTO ##ENCABEZADO
					SELECT TOP 1
					 IM.IMP_nc_open3_ncompr		NROCOMPROBANTE
					,IM.IMP_nc_open3_feccon		FECHACON
					,IM.IMP_nc_open3_fecdoc		FECHADOC
  ...
  --HISTORICO--
	SET @SQLSTR=CONCAT(' INSERT INTO ##ENCABEZADO
					SELECT TOP 1
					 IM.IMP_nc_hist3_ncompr		NROCOMPROBANTE
					,IM.IMP_nc_hist3_feccon		FECHACON
					,IM.IMP_nc_hist3_fecdoc		FECHADOC
