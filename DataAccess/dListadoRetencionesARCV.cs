...
{
	public class dListadoRetencionesARCV
	{
        public List<eDocumentos> ListadoRetencionesARCV(eFiltroDocumentos filtrodocumento)
        {
            ...
            if (!Object.ReferenceEquals(null, SQLConection))
            {
                try
                { //cambiar por Sp
                    SqlCommand cmd = new SqlCommand("PL_WEBListRetencionesARCVVOG_S", SQLConection);
