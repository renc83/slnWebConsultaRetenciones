...
{
	public class dRetencionIvaEnc
	{
		public eRetencionIvaEnc BuscarRetencionIvaEnc(eFiltroDocumentos filtrodocumento)
		{
            ...
            if (!Object.ReferenceEquals(null, SQLConection))
            {
                try
                { //cambiar por Sp
                    SqlCommand cmd = new SqlCommand("PL_WEB_RetIvaEncVOG_S", SQLConection);
